/**
 * RonVick Gas - Gas Accessories Page
 * Complete production script with all accessory products.
 */
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Filtered from main product list to include only relevant categories
    const allProducts = [
        {
            id: 'prod_regulator',
    ...
    function renderProducts() {
        ...
        if (paginatedProducts.length === 0) {
            grid.innerHTML = '<p class="no-products">No accessories found.</p>';
        } else {
        ...
        const content = `
            ...
            <div class="quick-view-info">
                ...
                <p class="quick-view-description">
                    This premium gas accessory is designed for both home and industrial use, featuring the highest safety standards and durability.
                </p>
    ...
    function initFilters() {
        ...
        document.getElementById('applyFilters')?.addEventListener('click', function() {
            ...
            document.getElementById('accessoriesSidebar')?.classList.remove('active');
            document.body.style.overflow = '';
        });
    ...
    function initMobileNav() {
        ...
        const accessoriesSidebar = document.getElementById('accessoriesSidebar');
        const sidebarClose = document.getElementById('sidebarClose');
        if (filterToggle && accessoriesSidebar && sidebarClose) {
            filterToggle.addEventListener('click', () => {
                accessoriesSidebar.classList.add('active');
                document.body.style.overflow = 'hidden';
            });
            sidebarClose.addEventListener('click', () => {
                accessoriesSidebar.classList.remove('active');
                document.body.style.overflow = '';
            });
            window.addEventListener('click', (e) => {
                if (e.target === accessoriesSidebar) {
                    accessoriesSidebar.classList.remove('active');
                    document.body.style.overflow = '';
                }
            });
